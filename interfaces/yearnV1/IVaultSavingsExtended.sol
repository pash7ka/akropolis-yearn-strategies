...
interface IVaultSavingsExtended { 
    ...
    function isSupportTokenForVault(address _vault, address _token) view external returns(bool);

    function supportTokensForVault() view external returns(address[] memory);
