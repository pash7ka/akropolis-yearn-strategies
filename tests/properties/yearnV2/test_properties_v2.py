...
@settings(max_examples=50)
def test_emergency_vault_deposit_reverts(token, vault, vaultSavings, deployer, user):
...
@settings(max_examples=50)
def test_emergency_vault_withdraw_reverts(token, vault, vaultSavings, deployer, user):
